...
main :: proc() 
{
 ...
 SCREEN_WIDTH = FULL_SCREEN ? 0 : width_windowed
 SCREEN_HEIGHT = FULL_SCREEN ? 0 : height_windowed
 ...
 {
  rl.ToggleFullscreen()
  SCREEN_WIDTH = rl.GetMonitorWidth(rl.GetMonitorCount() - 1)
  SCREEN_HEIGHT = rl.GetMonitorHeight(rl.GetMonitorCount() - 1)
 }
 ...
 for !rl.WindowShouldClose() 
 {
  ...
  //window gaining focus event
  if rl.IsWindowFocused() && !window_focused 
  {
   window_focused = true
  }
  if !rl.IsWindowFocused() && window_focused 
